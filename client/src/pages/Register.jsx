...
export default function Register() {
  ...
  const validatePassword = (pw) => {
    const errors = [];
    if (!/[A-Z]/.test(pw)) errors.push('Must have an uppercase letter');
    if (!/[a-z]/.test(pw)) errors.push('Must have a lowercase letter');
    if (pw.length < 6) errors.push('Length must be at least 6 characters');
    return errors;
  };
      ...
      >
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition"
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 font-medium py-2.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition"
          >
